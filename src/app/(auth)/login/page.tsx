...
import { Settings, ShieldCheck, ArrowRight, Lock, User, Pencil, Calculator } from "lucide-react";
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-[#020617] overflow-hidden">
        ...
        <div className="flex flex-col gap-4 text-center lg:text-left">
          ...
          >
            ...
            <h1 className="text-7xl md:text-9xl font-black text-white tracking-tighter leading-none mb-4">
              OrcaFácil<span className="text-violet-500">.</span>
            </h1>
            <p className="text-white/40 text-sm md:text-base font-medium max-w-md tracking-wide leading-relaxed">
              Simplificando a gestão de orçamentos com tecnologia de ponta para prestadores de elite.
            </p>
            ...
            <div className="mt-12 flex items-center gap-8 justify-center lg:justify-start opacity-30 grayscale hover:grayscale-0 transition-all">
                <div className="flex items-center gap-2">
                   <Settings className="animate-spin" style={{ animationDuration: '10s' }} size={20} />
                   <span className="text-[10px] font-mono uppercase tracking-widest">Core Engine Active</span>
                </div>
                <div className="flex items-center gap-2">
                   <ShieldCheck size={20} />
                   <span className="text-[10px] font-mono uppercase tracking-widest">Encrypted Session</span>
                </div>
            </div>
          </motion.div>
        </div>
            ...
            <div className="relative z-10">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full bg-black/40 border border-white/5 rounded-2xl pl-14 pr-6 py-5 text-sm font-medium text-white focus:outline-none focus:ring-1 focus:ring-violet-500/50 focus:bg-black/60 transition-all placeholder:text-white/10"
                      required
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-violet-600 hover:bg-violet-500 text-white rounded-2xl py-5 text-[11px] font-black uppercase tracking-[0.4em] shadow-[0_10px_40px_-10px_rgba(139,92,246,0.5)] transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-3 mt-4"
                >
                  {loading ? (
                     <>
              ...
              <div className="mt-10 text-center">
                <Link href="/signup" className="text-[10px] font-bold text-white/20 hover:text-white transition-colors uppercase tracking-[0.3em]">
                   Não tem uma conta? <span className="text-violet-500">Cadastre-se</span>
                </Link>
              </div>
            </div>
          </motion.div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 opacity-20 hidden md:block">
         <p className="text-[9px] font-mono uppercase tracking-[0.5em] text-white">
           OrcaFácil Technical Environment © 2026 // v1.4.0
         </p>
      </div>
